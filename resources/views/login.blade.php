...
<head lang="en">
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/separate/pages/login.min.css') }}">
...
<script src="{{ URL::asset('js/lib/jquery/jquery-3.2.1.min.js') }}"></script>
<script src="{{ URL::asset('js/lib/popper/popper.min.js') }}"></script>
<script src="{{ URL::asset('js/lib/tether/tether.min.js') }}"></script>
